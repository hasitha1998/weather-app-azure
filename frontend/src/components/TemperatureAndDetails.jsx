  ...
  return (
    <div>
        ...
        space-x-2 text-white text-sm py-3'>
          ...
          className='font-medium ml-1'>{formatLocalTime(sunrise, timezone,"hh:mm a")}</span></p>
          ...
          className='font-medium ml-1'>{formatLocalTime(sunset, timezone,"hh:mm a")}</span></p>
          <p className='font-light'>|</p>
          ...
          className='font-medium ml-1'>{`${temp_max.toFixed()}°`}</span></p>
          <p className='font-light'>|</p>
          ...
          className='font-medium ml-1'>{`${temp_min.toFixed()}°`}</span></p>
          <p className='font-light'>|</p>
          </div>
